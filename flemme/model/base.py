...
from flemme.block import PositionEmbeddingBlock
...
class BaseModel(nn.Module):
    ...
    def __init__(self, model_config, create_encoder_fn):
        ...
        ### point2encoder
        if self.encoder_name in ['MedMamba']:
            if self.decoder_name in ['MedMamba']:
    ...
    def encode(self, x, c = None, **kwargs):
        ...
        if c is not None:
            #kwargs = kwargs | {'c': c}
            kwargs = {**kwargs, 'c': c}  # Python 3.8 compatible
